...
MAINTAINER Björn A. Grüning, Dave Bovier
...
RUN apt-get -qq update && apt-get install --no-install-recommends -y \
    ...
    openjdk-7-jre-headless python-setuptools python-virtualenv \
    zlib1g-dev libyaml-dev subversion python-dev pkg-config && \
